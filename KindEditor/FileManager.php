...
*/
class KindEditor_FileManager extends Widget_Abstract_Contents implements Widget_Interface_Do {
	
	public function execute() {
		if(!Typecho_Widget::widget('Widget_User')->pass('contributor', true)) {
			echo 'No login or timeout.';
			exit;
		}
	}
	...
	public function action() {
		...
		$root_path = $usrPath . $attachPath . '/';
		$root_url = $siteUrl . 'usr/' . $attachPath .'/';
